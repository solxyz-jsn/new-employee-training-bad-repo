package jp.co.solxyz.jsn.springbootadvancedexam.application.book.cart;
...
public class BookCartUseCase {
    ...
    public BookCartUseCase(BookInventoryManager b1, BookLendingManager b2) {
        this.bim = b1;
        this.blm = b2;
    }
