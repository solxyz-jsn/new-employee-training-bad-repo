...
import jp.co.solxyz.jsn.springbootadvancedexam.presentation.user.book.json.ReturnBookIsbn;
...
public class BookReturnApiController {
     ...
     * 書籍返却サービス
     */
    private final BookLendingUseCase bookReturnService;

    /**
     * コンストラクタ
     * @param bookReturnService 書籍返却サービス
     */
    public BookReturnApiController(BookLendingUseCase bookReturnService) {
    ...
    public ResponseEntity<Void> returnBook(@RequestBody ReturnBookIsbn returnBookIsbn,
        ...
        try {
            bookReturnService.henkyaku(userDetails.getUserId(), returnBookIsbn.getIsbn());
